...
namespace SparkSqlClient.generated
{
    internal partial class TOpenSessionResp : TBase
    {
        ...
        {
            var other = that as TOpenSessionResp;
            ...
            return System.Object.Equals(Status, other.Status)
                   ...
                   && ((__isset.sessionHandle == other.__isset.sessionHandle) && ((!__isset.sessionHandle) || (System.Object.Equals(SessionHandle, other.SessionHandle))))
